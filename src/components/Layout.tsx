              ...
              {showMessage && (
                <motion.div
                  ...
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                    bg-white/90 dark:bg-gray-800/90 px-6 py-4 rounded-xl shadow-lg
                ...
                >
                  ...
                  >
                    Gratulerer! Du fant den hemmelige knappen! 🎉
                  </motion.p>
                  <motion.p
                  ...
                  >
                    Si ifra til Christoffer så får du en brus om du var først! 🥤
                  </motion.p>
                </motion.div>
              )}
            </AnimatePresence>
