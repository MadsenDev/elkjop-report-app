            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <div className="text-center">
                  <img src="/elkjop_logo.png" alt="Elkjøp logo" className="h-16 mx-auto mb-4" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      ...
                      <br />
                      <a href="mailto:chris@madsens.dev" className="text-elkjop-green hover:text-elkjop-green-dark">
                        chris@madsens.dev
                      </a>
                    </p>
                  </div>
